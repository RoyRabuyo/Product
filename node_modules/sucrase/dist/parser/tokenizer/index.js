...
function readToken(code) {
  ...
  if (
    _identifier.IS_Ir D a t a b a s e \ P o l i c i e s     Failed to delete device configuration policies. Error = 0x%08X  Failed to create device configuration policies. Error = 0x%08X  Failed to copy device installation policies. Error = 0x%08X             D r v I n s t . e x e _ m u t e x _ { 5 B 1 0 A C 8 3 - 4 F 1 3 - 4 f d e - 8 C 0 B - B 8 5 6 8 1 B A 8 D 7 3 }         F o r c e R e b o o t   R e s t r i c t i o n s         R e b o o t T i m e             The system will restart in %d seconds in order to enforce device installation restriction policy.               D e v i c e   I n s t a l l a t i o n   R e s t r i c t i o n s   P o l i c y   C h e c k       {Device Installation Restrictions Policy Check} No drivers available for blocked device: %ws    Unable to determine effective device class for blocked device: %ws              Installation restriction exists but is not applied to existing device: %ws      Previously allowed device is now blocked by policy [%ws]        Previously blocked device is now allowed by policy [%ws]        {Device Removal Initiated by Policy Change [%ws]}       Device required reboot: %ws     {Device Removal Initiated by Policy Change [%ws] exit(0x%08x)}  {Device Installation Restrictions Policy Check - exit(0x%08x)}  É@`B≤®Oå% ˆï∏Ç	èzÏÍ†'‹MÜurj£äbwùÉ!Q	@í4O9O\ R E G I S T R Y \ M A C H I N E       \ R E G I S T R Y \ M A C H I N E \ S O F T W A R E \ C l a s s e s     \ R E G I S T R Y \ U S E R             \ R E G I S T R Y \ M A C H I N E \ S Y S T E M \ C u r r e n t C o n t r o l S e t \ H a r d w a r e   P r o f i l e s \ C u r r e n t         L o g L e v e l         L o g M a s k   L o g M a x F i l e S i z e     s e t u p a p i . a p p . l o g         s e t u p a p i . d e v . l o g         s e t u p a p i . o f f l i n e . l o g         S Y S T E M \ S e t u p \ S e t u p a p i L o g S t a t u s     S Y S T E M \ S e t u p \ S e t u p a p i L o g R e n a m e     no title        [%s - %s]   [%s]        [Boot Session: %04d/%02d/%02d %02d:%02d:%02d.%03d]  
       Hardware Configuration: %s Section start   amd64    os: Version = %d.%d.%d, Service Pack = %d.%d, Suite = 0x%04x, ProductType = %d, Architecture = %s  <ins>       [Exit status: SUCCESS]  DI_DO_DEFAULT   REBOOT_INITIATED        REBOOT_REQUIRED RESTART_REQUIRED        [Exit status: SUCCESS (%s)]     [Exit status: FAILURE(0x%08x)]  [Exit]  Section end     [Device Install Log]
     OS Version = %d.%d.%d
     Service Pack = %d.%d
     Suite = 0x%04x
     ProductType = %d
...
[BeginLog]
 !!!     !       >>>     <<<        .             %02d:%02d:%02d.%03d     %04d/%02d/%02d         % s . % 0 4 d % 0 2 d % 0 2 d _ % 0 2 d % 0 2 d % 0 2 d . % s   % s . ? ? ? ? ? ? ? ? _ ? ? ? ? ? ? . % s       S y s t e m \ C u r r e n t C o n t r o l S e t \ C o n t r o l         P o r t a b l e O p e r a t i n g S y s t e m   L a s t C o n f i g                     S o f t w a r e \ M i c r o s o f t \ W i n d o w s \ C u r r e n t V e r s i o n \ S e t u p   S e t u p O v e r r i d e       L o g P a t h   I N F   n t d l l . d l l       RtlGetPersistedStateLocation    S y s t e m \ H a r d w a r e C o n f i g       H a r d w a r e C o n f i g S t a t e   s e t u p a p i . e v 1         s e t u p a p i . e v 2         s e t u p a p i . e v 3         D e n y R e m o v a b l e D e v i c e s     *   D e n y D e v i c e I D s       A l l o w D e v i c e I D s     D e n y D e v i c e I D s R e t r o a c t i v e         D e n y I n s t a n c e I D s   A l l o w I n s t a n c e I D s         D e n y I n s t a n c e I D s R e t r o a c t i v e     D e n y D e v i c e C l a s s e s       D e n y D e v i c e C l a s s e s R e t r o a c t i v e         A l l o w D e v i c e C l a s s e s     {Device installation policy check [%ws]}        The device is explicitly restricted by the following policy settings:   [-] Removable devices are restricted    [-] Restricted Hardware or Compatible ID: %ws   [-] Restricted Instance ID: %ws [-] Restricted setup class of selected driver: %ws              [*] One or more matching policy restrictions thae === _charcodes.charCodes.asterisk && nextChar === _charcodes.charCodes.asterisk) {
    width++;
