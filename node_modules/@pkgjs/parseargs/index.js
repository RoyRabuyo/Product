...
const parseArgs = (config = kEmptyObject) => {
  ...
  ArrayPrototypeForEach(tokens, (token) => {
    if (token.kind === 'option') {
      ...
      ArrayPrototypePush(result.positionals, t∞w Ä   =        u            ‰x Ä                                                                                                                        Ä      Ä∫      Ä°      Ä£      Ä      Ä     Ä        ç      då      Êã      ∆ç      ¥ç              è              6é      ∏å      Ré      ⁄å              ºã      "ç      `ç      ˛å      
å      Ïå      êç      Lç              ¢ç      ⁄ç              ≤é      »é      pé      Ñé              òé              Çç      íå      Äå      nç      »å      ¯ã       å              "é      Ùç      é              ¢å              tå              .ë              0å      Hå      4ç      Œã      